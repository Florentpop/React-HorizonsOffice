	...
	<div className="container-fluid">
        ...
        <div className="carousel-inner" role="listbox">
          <div className="item active">
                <img src="Images/Horizons7.jpg" alt="Horizons Offices"></img>
          </div>

          <div className="item">
                <img src="Images/IMG-20200313-WA0012.jpg" alt="Horizons Offices"></img>
          </div>

          <div className="item">
                <img src="Images/IMG-20200313-WA0013.jpg" alt="Horizons Offices"></img>
          </div>
      ...
      <div className="row">
        ...
        <div className="thumbnail">
              <img src="Images/virtual.jpg" alt="VIRTUAL OFFICES"></img>
        ...
        <div className= "col-md-3">
          <div className="thumbnail">
              <img src="Images/Customized-offices.jpg" alt="CUSTOMIZED OFFICES"></img>
          <div className="caption">
        ...
        <div className= "col-md-3">
        <div className="thumbnail">
              <img src="Images/Service offices.jpg" alt="SERVICED OFFICES"></img>
          <div className="caption">
        ...
        <div className= "col-md-3">
        <div className="thumbnail">
              <img src="Images/Meeting.jpg" alt="MEETING ROOMS"></img>
          <div className="caption">
            <h3>MEETING ROOMS</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
